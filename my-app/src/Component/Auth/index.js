...
//                 <img src="https://1000logos.net/wp-content/uploads/2016/11/New-Google-Logo-768x773.jpg" alt="google" />
            ...
            <div className="auth-container">
                ...
                <div className="auth-login">
                    <div className="auth-login-container">
                        ...
                        <p
                            onClick={() => setRegister(!register)}
                            style={{ marginTop: "10px", textAlign: "center", color: "#0095ff", textDecoration: "underline", cursor: "pointer", }}>
                            {register ? "Login" : "Register"} ? </p>
                    </div>
                </div>
                {error !== "" && (
